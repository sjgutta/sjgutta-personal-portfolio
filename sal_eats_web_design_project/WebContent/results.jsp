...
<h1 style="margin-top: 4vh; margin-bottom: 4vh; color: grey; font-weight: normal;">Results for "<%=request.getAttribute("name") %>"</h1>
</div>
<div style="padding-right:5vw; padding-left: 5vw;">
<% ArrayList<Restaurant> results = (ArrayList<Restaurant>)request.getAttribute("results");
if(results!=null){
	for(int i=0; i<results.size(); i++){
		String name = results.get(i).name;
		String address = results.get(i).address;
		String page_link = results.get(i).page_link;
		String image_link = results.get(i).image_link;
		int rating = results.get(i).rating;
		String yelp_id = results.get(i).yelp_id;
	%><div style="color: grey; height: 44vh; border-bottom: 1px dashed grey; border-top: 1px dashed grey;">
