...
* Designed and implmeented an object oriented redirect system for Discotech's web application. Many of the old links for venues, cities, events, etc. have been changed but we don't want existing links to break.
